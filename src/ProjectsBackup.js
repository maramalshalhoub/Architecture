...
handleClick=(e)=>{
//   const pictures = data.properties.map((object) => {
//     if(object.parent== e.target.textContent){
//       pictures.push.object.picture}
//     console.log(Array.pictures.push.object.picture)
//      <data picture={picture} key={picture.id} />
// })
//  {pictures}
